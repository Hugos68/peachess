	...
	return function (Stockfish) {
		...
		function Qa(a, b) {
			...
			var c = Atomics.load(v(), V >> 2),
				e = 0;
			if (c == a && Atomics.compareExchange(v(), V >> 2, c, 0) == c && (--b, (e = 1), 0 >= b))
				return 1;
		...
		var Ta = (z._emscripten_register_main_browser_thread_id = function () {
				return (Ta = z._emscripten_register_main_browser_thread_id = z.asm.Q).apply(
					null,
					arguments
				);
			}),
			...
			Xa = (z._emscripten_main_thread_process_queued_calls = function () {
				return (Xa = z._emscripten_main_thread_process_queued_calls = z.asm.U).apply(
					null,
					arguments
				);
			}),
