...
{#key $chessStore}
    <div class="flex gap-1">
        ...
        <button disabled={chessStore.getCurrentMoveHistory().length===chessStore.getTotalMoveHistory().length} on:click={chessStore.loadNextMove} class="btn btn-sm variant-filled-primary">
